	...
	<div class="container-fluid">
		<div class="row">
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				...
				<h1>시간외 근무내역 상세보기</h1>
				<h2>글번호 : ${timeover.num_timeover}</h2>
				<h4>신청자(별명) : ${timeover.user_nick_timeover}</h4>
				<h4>신청자(이메일) : ${timeover.user_email_timeover}</h4>
				<h4>신청일 : ${timeover.date_timeover} /
					${timeover.start_timeover} ~ ${timeover.end_timeover}</h4>
				<h4>근무 사유 : ${timeover.reason_timeover}</h4>
...
<form action="staffServlet" method="post" name="answer">
	<input type="hidden" name="command" value="resultTimeover"> <input
		type="hidden" name="num" value="${timeover.num_timeover}">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-head er">
					<h5 class="modal-title" id="exampleModalLabel">시간외 근무 처리하기</h5>
