		...
		<section class="panel">
			<div class="intro color2">
				<h2 class="major" id="maintext">
					<script>
						const name = window.parent.document
			...
			<div class="gallery">
				<a href="" class="image filtered span-2-5" data-position="top"><img
					id="img1" src="" alt="" /></a>
				<script>
					const img1 = window.parent.document
							.getElementById("fileNm1").value;
			...
			<div class="gallery">
				<a href="" class="image filtered span-2-5" data-position="top"><img
					id="img2" src="" alt="" /></a>
				<script>
					const img2 = window.parent.document
							.getElementById("fileNm1").value;
					document.getElementById('img1').src = "upload/" + img2;
				</script>
			</div>
			<div class="gallery">
				<a href="" class="image filtered span-2-5" data-position="top"><img
					id="img3" src="" alt="" /></a>
				<script>
					const img3 = window.parent.document
							.getElementById("fileNm1").value;
					document.getElementById('img1').src = "../upload/" + img3;
				</script>
			</div>
			<div class="gallery">
				<a href="" class="image filtered span-2-5" data-position="top"><img
					id="img4" src="" alt="" /></a>
				<script>
					const img4 = window.parent.document
							.getElementById("fileNm4").value;
...
>>>>>>> branch 'master' of C:\Users\zhfld\Documents\GitHub\newProj1\moongnyang
</html>