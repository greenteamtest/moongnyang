...
<body>
		<table border="1">
			...
			<tr >
				<td rowspan="13"><a href="BoardServlet_picnic?command=abandonment_view&num=${list.desertionNo }"> <img src="${list.popfile }" width="330" height="330"></a></td>
			</tr>
			<tr>
			...
			<tr>
				<td>성별(M:수컷,F:암컷,Q:미상) : ${list.sexCd}</td>
			</tr>
			<tr>
				<td><br></td>
			</tr>			
